...
public class Constant {
    ...
    public static final String SERVER = "https://q.willh.cn/graw/YHLFurry/GameWxQRlogin/main/";
    public static final String API_VERSION = SERVER + "config/v.json";
    public static final String API_MENU = SERVER + "games/gameList-test.json";
